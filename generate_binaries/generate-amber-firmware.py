...
variants = [
    {"pcb": "v2", "parity": "EVEN", "relays": "4", "updatefile": "release-v2-4relay-even.json", "foldername": "firmware-4relay"},
    {"pcb": "v2", "parity": "NONE", "relays": "4", "updatefile": "release-v2-4relay-none.json", "foldername": "firmware-4relay"},
    {"pcb": "v2", "parity": "EVEN", "relays": "2", "updatefile": "release-v2-2relay-even.json", "foldername": "firmware-2relay"},
    {"pcb": "v2", "parity": "NONE", "relays": "2", "updatefile": "release-v2-2relay-none.json", "foldername": "firmware-2relay"},
    {"pcb": "v3", "parity": "EVEN", "relays": "4", "updatefile": "release-v3-4relay-even.json", "foldername": "firmware-4relay"},
    {"pcb": "v3", "parity": "NONE", "relays": "4", "updatefile": "release-v3-4relay-none.json", "foldername": "firmware-4relay"},
    {"pcb": "v3", "parity": "EVEN", "relays": "2", "updatefile": "release-v3-2relay-even.json", "foldername": "firmware-2relay"},
    {"pcb": "v3", "parity": "NONE", "relays": "2", "updatefile": "release-v3-2relay-none.json", "foldername": "firmware-2relay"}
]

for v in variants:
    parity = v["parity"].lower()
    version = f"PCB {v['pcb']} with parity {v['parity']} and {v['relays']} relays"
    ...
    result = subprocess.run(f"esphome -s uart_parity {v['parity']} -s relays {v['relays']} -s pcb_version {v['pcb']} compile {base_yaml}", capture_output=True, text=True)
    ...
    if result.returncode == 0:
        ...
        version_filename = f"version-{version_number.replace('.', '-')}-{v['pcb']}-{parity}.bin"
        ...
        latest_filename = f"../{v['foldername']}/latest-{v['pcb']}-{parity}.bin"
        ...
        pathlib.Path(f"../{v['foldername']}/latest-{v['pcb']}-{parity}.md5").write_text(md5)
